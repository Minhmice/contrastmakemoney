...
const MUSIC_TRACKS: MusicTrack[] = [
  {
    ...
    src: '/songs/06 - Michael Jackson - Billie Jean.flac',
  },
...
export function ManifestoSection() {
  ...
  const setTileDelay = (delay: string): CSSProperties =>
    ({ '--tile-delay': delay }) as CSSProperties
  ...
  return (
    <section
      ...
      id="contrast"
      aria-label="Bản xem trước workspace Contrast"
    >
      <div
        className="manifesto__workbench"
        data-visible={hasEntered}
        role="group"
        aria-label="Bản xem trước workspace"
      >
        <article
          className="manifesto-tile manifesto-tile--streak"
          style={setTileDelay('0ms')}
        >
        ...
        <button
          ...
          aria-label="Tới ngay Contrast Workspace."
        ...
        <article
          className="manifesto-tile manifesto-tile--checkin"
          style={setTileDelay('140ms')}
        >
          <div className="manifesto-tile__topline">
          ...
          <div
            className="manifesto-checkin"
            role="img"
            aria-label="Lịch check-in minh hoạ theo phong cách GitHub"
          >
            ...
            <div className="manifesto-checkin__grid" aria-hidden="true">
              {CHECKIN_LEVELS.map((level, index) => (
                <span
                  className={`manifesto-checkin__cell manifesto-checkin__cell--${level}`}
                  key={`${level}-${index}`}
                />
              ))}
            </div>
        ...
        >
          ...
          <div className="manifesto-turntable" aria-hidden="true">
            <div className="manifesto-record">
              <div className="manifesto-record__label">C</div>
            </div>
            <div className="manifesto-tonearm">
              <span className="manifesto-tonearm__head" />
            </div>
          </div>
          <div className="manifesto-music__bottom">
            ...
            <div className="manifesto-music__controls">
              ...
              >
                {isPlaying ? (
                  <Square size={16} fill="currentColor" strokeWidth={1.8} />
                ) : (
        ...
        <article
          className="manifesto-tile manifesto-tile--tasks"
          style={setTileDelay('280ms')}
        >
          <div className="manifesto-tile__topline">
              ...
              <li className={task.done ? 'is-done' : ''} key={task.id}>
                ...
                >
                  {task.done ? (
                    ...
                    <Circle size={15} strokeWidth={1.5} aria-hidden="true" />
                  )}
                </button>
        ...
        <article
          className="manifesto-tile manifesto-tile--pomodoro"
          style={setTileDelay('350ms')}
        >
          <div className="manifesto-tile__topline">
      ...
      <div className="manifesto__cta" data-visible={hasEntered}>
        <PublicActionButton className="manifesto__workspace-action" onClick={openWorkspace}>
          VÀO WORKSPACE
        </PublicActionButton>
      </div>
    </section>
